...
// Lucide-style glyphs used across the storefront and admin (merged from the
// prototype's I + I2 sets).
...
export function Icon({ name, size = 18, stroke = 2.2 }: { name: string; size?: number; stroke?: number }) {
  return (
