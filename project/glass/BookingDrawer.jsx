  ...
  return (
    <>
      ...
      <div style={{
        ...
        background:"rgba(255,253,250,0.65)",backdropFilter:"blur(16px) saturate(140%)",WebkitBackdropFilter:"blur(16px) saturate(140%)",borderLeft:"1px solid rgba(60,40,28,0.08)",
        zIndex:51,boxShadow:"-12px 0 40px rgba(28,15,5,0.10)",
        display:"flex",flexDirection:"column",animation:"co-slide .22s var(--ease-snap)",
        overflowY:"auto",
      }}>
        {/* Header */}
        <div style={{position:"sticky",top:0,background:`var(--color-${meta.color})`,color:`var(--color-${meta.fg})`,borderBottom:"1px solid rgba(60,40,28,0.08)",padding:"18px 22px",display:"flex",alignItems:"flex-start",gap:14,zIndex:1}}>
          <div style={{flex:1,minWidth:0}}>
            <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
              ...
              {booking.status==="inprogress" && <span style={{display:"inline-flex",alignItems:"center",gap:5,fontSize:10,fontWeight:800,letterSpacing:".1em",textTransform:"uppercase",padding:"3px 8px",background:"rgba(36,24,15,0.72)",backdropFilter:"blur(24px) saturate(140%)",WebkitBackdropFilter:"blur(24px) saturate(140%)",color:"var(--color-cream)",borderRadius:6}}><Dot color="sun" pulse size={7}/> On floor</span>}
            </div>
          ...
          <button onClick={onClose} style={{width:36,height:36,border:"1px solid rgba(60,40,28,0.10)",borderRadius:11999,background:"rgba(255,253,250,0.65)",backdropFilter:"blur(16px) saturate(140%)",WebkitBackdropFilter:"blur(16px) saturate(140%)",color:"var(--color-espresso)",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,boxShadow:"0 4px 14px rgba(28,15,5,0.06), 0 1px 2px rgba(28,15,5,0.03)"}}><I2 name="x" size={16}/></button>
        </div>

        <div style={{padding:22,display:"flex",flexDirection:"column",gap:16}}>
          {/* Schedule strip */}
          <div style={{padding:14,border:"1px solid rgba(60,40,28,0.10)",borderRadius:18,background:"rgba(255,255,255,0.72)",backdropFilter:"blur(20px) saturate(160%)",WebkitBackdropFilter:"blur(20px) saturate(160%)",display:"flex",alignItems:"center",gap:14,boxShadow:"0 4px 14px rgba(28,15,5,0.06), 0 1px 2px rgba(28,15,5,0.03)"}}>
            <I2 name="cal" size={22}/>
            <div style={{flex:1}}>
          ...
          {/* Customer */}
          <div style={{padding:14,border:"1px solid rgba(60,40,28,0.10)",borderRadius:18,background:"rgba(255,255,255,0.72)",backdropFilter:"blur(20px) saturate(160%)",WebkitBackdropFilter:"blur(20px) saturate(160%)",display:"flex",alignItems:"center",gap:12,boxShadow:"0 4px 14px rgba(28,15,5,0.06), 0 1px 2px rgba(28,15,5,0.03)"}}>
          ...
          <Panel title="Pricing" actions={<Pill variant={booking.paid?"matcha":"tomato"}>{booking.paid?"Paid":"Unpaid"}</Pill>}>
            <div style={{display:"flex",flexDirection:"column",gap:8}}>
              ...
              <div style={{borderTop:"1px dashed rgba(60,40,28,0.06)",margin:"4px 0"}}/>
